...
export class DistrictDataService {
  ...
  public getDistrict(disId:any) : Observable<any> {
  ...
  public getDivision(disId:any) : Observable<any> {
  const url = "http://114.143.217.43:8080/getDivisionsV2";
    let queryParams = new HttpParams();
  ...
  public getSubDivision( divId:any, disId:any) : Observable<any> {
    const url = "http://114.143.217.43:8080/getSubDivisionsV2";
    let queryParams = new HttpParams();
    queryParams =  queryParams.append('divId', divId);
    // queryParams =  queryParams.append('divName', divName);
    queryParams =  queryParams.append('disId', disId);
